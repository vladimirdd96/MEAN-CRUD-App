...
export class OfficeService {
  ...
  createOffice(
    ...
    return this.webService.post(`company/${_companyId}/offices`, {
      countryName,
      cityName,
      streetName,
      streetNumber,
  ...
  headquarters(companyId: string, office: Office) {
    ...
    return this.webService.patch(
      `company/${companyId}/offices/${office._id}/employees`,
  ...
  createEmployee(
    ...
    return this.webService.post(
      `company/${_companyId}/offices/${_officeId}/employees`,
      {
        firstName,
        lastName,
        startingDate,
